...
loInstaller = createobject('UTCDateTimeInstaller')
loInstaller.Install()

define class UTCDateTimeInstaller as FoxGet of FoxGet.prg
	cBaseURL = 'https://raw.githubusercontent.com/atlopes/UTCDatetime/master/source/'
...
* no custom tasks to perform.
	...
	function Setup
		This.AddFile('utcdatetime.prg', .T., This.cPackagePath)
	endfunc
enddefine
