...
loInstaller = createobject('OOPReportsInstaller')
loInstaller.Install()

define class OOPReportsInstaller as FoxGet of FoxGet.prg
	cBaseURL = 'https://raw.githubusercontent.com/VFPX/OOPReports/master/'
...
* no custom tasks to perform.
	...
	function Setup
		...
		This.AddFile('sfrepobj.h',   .F., This.cPackagePath)
		This.AddFile('sfrepobj.vct', .F., This.cPackagePath)
		This.AddFile('sfrepobj.vcx', .T., This.cPackagePath)
	endfunc
enddefine
